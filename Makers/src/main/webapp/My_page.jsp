...
<body>
  <div class="e270_6138">
    ...
    <span class="e270_6089"><a href="Login.html">SIGN OUT</a></span>
    <span class="e270_6088"><a href="Main_Page.html">학습 대시보드</a></span>
    ...
    <form>
      <div>
        <input class="co_1" type="text" autofocus name="nick" placeholder="  한글/영문 1~10자">
        <input class="co_2" type="password" autofocus name="pw" placeholder="  영문 대/소문자, 숫자, 특수기호 포함 8~16자">
        <input class="co_3" type="password" autofocus name="re_pw" placeholder="  영문 대/소문자, 숫자, 특수기호 포함 8~16자">
        <input class="co_4" type="password" autofocus name="pw" placeholder="  영문 대/소문자, 숫자, 특수기호 포함 8~16자">
        <button class="co_5" type="button" onclick="window.location.href='Main_Page.html';">수정 완료</button>
      </div>
    </form>
